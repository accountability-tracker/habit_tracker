...
import 'package:habit_tracker/components/calendar/src/calendar_header.dart';
import 'package:habit_tracker/components/calendar/src/default_styles.dart';
import 'package:habit_tracker/components/calendar/src/weekday_row.dart';
import 'package:intl/date_symbol_data_local.dart';
import 'package:intl/intl.dart' show DateFormat;

import 'classes/multiple_marked_dates.dart';

export 'package:habit_tracker/components/calendar/classes/event_list.dart';
...
class CalendarCarousel<T extends EventInterface> extends StatefulWidget {
  ...
  final Color markedDayButtonColor;
  final TextStyle? markedDayTextColor;
  ...
  final OutlinedBorder? customShapeBorder;
  ...
  CalendarCarousel({
    ...
    this.markedDayButtonColor = Colors.green,
    this.markedDayTextColor = const TextStyle(),
        ...
        child: TextButton(
          style: TextButton.styleFrom(
            shape: widget.markedDateCustomShapeBorder != null &&
                ...
                : widget.customShapeBorder ?? (widget.daysHaveCircularBorder == null
                    ? CircleBorder()
            ...
            backgroundColor: isSelectedDay
                ...
                : markedDatesMap != null && markedDatesMap.getEvents(now).isNotEmpty
                ? widget.markedDayButtonColor
                : isToday
            ...
            children: widget.showIconBehindDayText
                ? <Widget>[
                    widget.markedDatesMap != null
                        ? Container() //_renderMarkedMapContainer(now)
                        : Container(),
                    getDayContainer(
                        isSelectable,
                        index,
                ...
                children: List.generate(totalItemCount,
                  ...
                  if (isPrevMonthDay && !widget.showOnlyCurrentMonthDate) {
                    ...
                    textStyle = isSelectedDay
                        ...
                        : markedDatesMap != null && markedDatesMap.getEvents(now).length > 0
                        ? widget.markedDayTextColor
                        : isToday
